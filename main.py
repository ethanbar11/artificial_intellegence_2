...
if __name__ == "__main__":
    players_options = [x + 'Player' for x in ['Live', 'Simple', 'Minimax', 'Alphabeta', 'GlobalTimeAB', 'LightAB',
                                              'HeavyAB', 'Compete','Compete_v1-0']]

    parser = argparse.ArgumentParser()

    parser.add_argument('-player1', default='Compete_v1-0Player', type=str,
    ...
    parser.add_argument('-board', default='test_board_6.csv', type=str,
    ...
    parser.add_argument('-penalty_score', default=1000, type=float,
    ...
    parser.add_argument('-terminal_viz', default="True", action='store_true',
