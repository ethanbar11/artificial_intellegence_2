...
def write_to_csv_file(file_name='./boards/generic_board.csv', n=30, m=30, p1_pos=None, p2_pos=None, min_fruits_number=0,
                      max_fruits_number=-1,
                      min_fruits_val=200,
                      max_fruits_val=500, fruits_dict=None, x_squares=None, min_x_squares=0, max_x_squares=-1):
...
if __name__ == "__main__":
    for i in range(4, 13):
        write_to_csv_file(file_name='.//boards//test_board_{}.csv'.format(i), n=7, m=7)
