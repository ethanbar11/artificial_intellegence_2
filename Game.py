...
class Game:
    ...
    def remove_fruit_from_board(self, pos):
        if self.map[pos[0], pos[1]] == self.fruits_on_board[pos][
            'value']:  # don't override a player if exists there. Safety first!
    ...
    #         num_fruits = random.randint(1, int(num_free_places * self.fruits_max_part_of_free_spaces))
